...
export const FOODS: FoodEntry[] = [
  ...
  // === HAMBURGER E PREPARATI ===
  { names: ["hamburger di pollo", "burger di pollo"], per100g: { calories: 170, protein_g: 19.0, carbs_g: 3.0, fat_g: 9.0, fiber_g: 0.5 } },
  { names: ["hamburger di tacchino", "burger di tacchino"], per100g: { calories: 160, protein_g: 20.0, carbs_g: 2.0, fat_g: 8.0, fiber_g: 0.5 } },
  { names: ["hamburger vegetale", "beyond burger", "burger vegetale"], per100g: { calories: 221, protein_g: 18.0, carbs_g: 5.0, fat_g: 14.0, fiber_g: 2.0 } },
  { names: ["hamburger di maiale", "burger di maiale"], per100g: { calories: 240, protein_g: 17.0, carbs_g: 1.0, fat_g: 19.0, fiber_g: 0 } },
  { names: ["macinato di maiale"], per100g: { calories: 260, protein_g: 17.0, carbs_g: 0, fat_g: 21.0, fiber_g: 0 } },
  { names: ["macinato misto", "carne macinata mista"], per100g: { calories: 220, protein_g: 18.0, carbs_g: 0, fat_g: 16.0, fiber_g: 0 } },
  { names: ["kebab", "doner kebab"], per100g: { calories: 215, protein_g: 16.0, carbs_g: 2.0, fat_g: 16.0, fiber_g: 0 } },
  { names: ["straccetti di manzo"], per100g: { calories: 160, protein_g: 22.0, carbs_g: 0, fat_g: 8.0, fiber_g: 0 } },
  { names: ["straccetti di pollo"], per100g: { calories: 115, protein_g: 23.0, carbs_g: 0, fat_g: 2.0, fiber_g: 0 } },
  { names: ["bocconcini di pollo", "chicken nuggets", "nuggets"], per100g: { calories: 220, protein_g: 15.0, carbs_g: 14.0, fat_g: 12.0, fiber_g: 1.0 } },
  { names: ["pollo impanato"], per100g: { calories: 230, protein_g: 17.0, carbs_g: 13.0, fat_g: 12.0, fiber_g: 0.5 } },

  // === PRODOTTI CONFEZIONATI / PANIFICAZIONE ===
  { names: ["lievito di birra"], per100g: { calories: 105, protein_g: 12.0, carbs_g: 14.0, fat_g: 2.0, fiber_g: 6.0 } },
  { names: ["lievito secco", "lievito istantaneo"], per100g: { calories: 325, protein_g: 40.0, carbs_g: 36.0, fat_g: 4.0, fiber_g: 20.0 } },
  { names: ["lievito per dolci", "lievito chimico"], per100g: { calories: 53, protein_g: 0, carbs_g: 28.0, fat_g: 0, fiber_g: 0 } },
  { names: ["lievito alimentare", "lievito in scaglie"], per100g: { calories: 325, protein_g: 50.0, carbs_g: 22.0, fat_g: 4.0, fiber_g: 25.0 } },
  { names: ["pangrattato"], per100g: { calories: 395, protein_g: 13.0, carbs_g: 72.0, fat_g: 5.0, fiber_g: 4.0 } },
  { names: ["farina di ceci"], per100g: { calories: 356, protein_g: 22.0, carbs_g: 47.0, fat_g: 6.0, fiber_g: 11.0 } },
  { names: ["farina di riso"], per100g: { calories: 366, protein_g: 6.0, carbs_g: 80.0, fat_g: 1.0, fiber_g: 2.0 } },
  { names: ["farina di mandorle"], per100g: { calories: 571, protein_g: 21.0, carbs_g: 20.0, fat_g: 50.0, fiber_g: 10.0 } },
  { names: ["farina di cocco"], per100g: { calories: 400, protein_g: 15.0, carbs_g: 60.0, fat_g: 12.0, fiber_g: 35.0 } },
  { names: ["farina di avena"], per100g: { calories: 379, protein_g: 13.0, carbs_g: 68.0, fat_g: 7.0, fiber_g: 10.0 } },
  { names: ["farina di farro"], per100g: { calories: 348, protein_g: 15.0, carbs_g: 67.0, fat_g: 2.5, fiber_g: 7.0 } },
  { names: ["semola", "semola rimacinata", "semola di grano duro"], per100g: { calories: 351, protein_g: 12.0, carbs_g: 73.0, fat_g: 1.0, fiber_g: 3.0 } },
  { names: ["semolino"], per100g: { calories: 360, protein_g: 13.0, carbs_g: 73.0, fat_g: 1.0, fiber_g: 3.5 } },
  { names: ["fecola di patate"], per100g: { calories: 357, protein_g: 0.1, carbs_g: 89.0, fat_g: 0, fiber_g: 0 } },
  { names: ["amido di mais", "maizena"], per100g: { calories: 381, protein_g: 0.3, carbs_g: 91.0, fat_g: 0.1, fiber_g: 0.9 } },
  { names: ["farina di grano saraceno"], per100g: { calories: 335, protein_g: 13.0, carbs_g: 71.0, fat_g: 3.0, fiber_g: 10.0 } },
  { names: ["farina di mais", "farina per polenta"], per100g: { calories: 362, protein_g: 8.0, carbs_g: 77.0, fat_g: 2.0, fiber_g: 5.0 } },
  { names: ["pan carre", "pane in cassetta"], per100g: { calories: 270, protein_g: 8.0, carbs_g: 48.0, fat_g: 5.0, fiber_g: 2.5 } },
  { names: ["pane proteico"], per100g: { calories: 260, protein_g: 22.0, carbs_g: 15.0, fat_g: 10.0, fiber_g: 8.0 } },
  { names: ["rosetta", "michetta"], per100g: { calories: 270, protein_g: 9.0, carbs_g: 52.0, fat_g: 3.0, fiber_g: 2.5 } },
  { names: ["panino al latte"], per100g: { calories: 310, protein_g: 9.0, carbs_g: 52.0, fat_g: 7.0, fiber_g: 2.0 } },

  // === CEREALI E GRANI AGGIUNTIVI ===
  { names: ["bulgur"], per100g: { calories: 342, protein_g: 12.0, carbs_g: 76.0, fat_g: 1.0, fiber_g: 18.0 } },
  { names: ["grano saraceno"], per100g: { calories: 343, protein_g: 13.0, carbs_g: 72.0, fat_g: 3.0, fiber_g: 10.0 } },
  { names: ["granola"], per100g: { calories: 450, protein_g: 10.0, carbs_g: 62.0, fat_g: 18.0, fiber_g: 7.0 } },
  { names: ["crusca d'avena", "crusca di avena"], per100g: { calories: 246, protein_g: 17.0, carbs_g: 66.0, fat_g: 7.0, fiber_g: 15.0 } },

  // === SALSE E CONDIMENTI AGGIUNTIVI ===
  { names: ["passata di pomodoro", "passata"], per100g: { calories: 24, protein_g: 1.0, carbs_g: 4.0, fat_g: 0.2, fiber_g: 1.0 } },
  { names: ["salsa rosa", "salsa cocktail"], per100g: { calories: 380, protein_g: 1.0, carbs_g: 18.0, fat_g: 34.0, fiber_g: 0 } },
  { names: ["salsa tartara"], per100g: { calories: 430, protein_g: 1.0, carbs_g: 5.0, fat_g: 45.0, fiber_g: 0 } },
  { names: ["salsa bbq", "salsa barbecue"], per100g: { calories: 172, protein_g: 1.0, carbs_g: 40.0, fat_g: 0.6, fiber_g: 0.5 } },
  { names: ["salsa piccante", "tabasco", "hot sauce"], per100g: { calories: 12, protein_g: 1.0, carbs_g: 1.0, fat_g: 0.4, fiber_g: 0.5 } },
  { names: ["sriracha"], per100g: { calories: 93, protein_g: 2.0, carbs_g: 19.0, fat_g: 1.0, fiber_g: 1.0 } },
  { names: ["guacamole"], per100g: { calories: 160, protein_g: 2.0, carbs_g: 9.0, fat_g: 15.0, fiber_g: 7.0 } },
  { names: ["tzatziki"], per100g: { calories: 55, protein_g: 3.0, carbs_g: 4.0, fat_g: 3.0, fiber_g: 0.5 } },
  { names: ["burro di mandorle"], per100g: { calories: 614, protein_g: 21.0, carbs_g: 7.0, fat_g: 56.0, fiber_g: 10.0 } },
  { names: ["crema di pistacchio"], per100g: { calories: 550, protein_g: 15.0, carbs_g: 30.0, fat_g: 42.0, fiber_g: 4.0 } },
  { names: ["crema spalmabile lotus", "lotus biscoff"], per100g: { calories: 580, protein_g: 4.0, carbs_g: 58.0, fat_g: 36.0, fiber_g: 1.0 } },
  { names: ["sciroppo d'agave", "sciroppo di agave"], per100g: { calories: 310, protein_g: 0, carbs_g: 76.0, fat_g: 0.5, fiber_g: 0.2 } },

  // === CARNE EXTRA ===
  { names: ["carne di cavallo"], per100g: { calories: 133, protein_g: 21.0, carbs_g: 0, fat_g: 5.0, fiber_g: 0 } },
  { names: ["carne di cinghiale", "cinghiale"], per100g: { calories: 160, protein_g: 22.0, carbs_g: 0, fat_g: 8.0, fiber_g: 0 } },
  { names: ["carne di cervo", "cervo"], per100g: { calories: 120, protein_g: 22.0, carbs_g: 0, fat_g: 3.0, fiber_g: 0 } },
  { names: ["carne di struzzo", "struzzo"], per100g: { calories: 113, protein_g: 22.0, carbs_g: 0, fat_g: 2.5, fiber_g: 0 } },
  { names: ["faraona"], per100g: { calories: 158, protein_g: 23.0, carbs_g: 0, fat_g: 7.0, fiber_g: 0 } },
  { names: ["quaglia"], per100g: { calories: 134, protein_g: 22.0, carbs_g: 0, fat_g: 5.0, fiber_g: 0 } },
  { names: ["bistecca alla fiorentina", "fiorentina"], per100g: { calories: 210, protein_g: 20.0, carbs_g: 0, fat_g: 14.0, fiber_g: 0 } },
  { names: ["entrecote", "costata", "ribeye"], per100g: { calories: 250, protein_g: 19.0, carbs_g: 0, fat_g: 19.0, fiber_g: 0 } },
  { names: ["bacon", "pancetta affumicata"], per100g: { calories: 541, protein_g: 12.0, carbs_g: 1.0, fat_g: 55.0, fiber_g: 0 } },
  { names: ["wurstel di pollo"], per100g: { calories: 230, protein_g: 13.0, carbs_g: 3.0, fat_g: 18.0, fiber_g: 0 } },
  { names: ["wurstel di tacchino"], per100g: { calories: 200, protein_g: 14.0, carbs_g: 3.0, fat_g: 14.0, fiber_g: 0 } },
  { names: ["salsiccia di pollo"], per100g: { calories: 170, protein_g: 18.0, carbs_g: 1.0, fat_g: 10.0, fiber_g: 0 } },
  { names: ["salsiccia di tacchino"], per100g: { calories: 160, protein_g: 19.0, carbs_g: 1.0, fat_g: 9.0, fiber_g: 0 } },
  { names: ["prosciutto di praga"], per100g: { calories: 130, protein_g: 20.0, carbs_g: 1.0, fat_g: 5.0, fiber_g: 0 } },

  // === DOLCI E SNACK AGGIUNTIVI ===
  { names: ["snickers"], per100g: { calories: 488, protein_g: 8.0, carbs_g: 59.0, fat_g: 24.0, fiber_g: 2.0 } },
  { names: ["mars"], per100g: { calories: 449, protein_g: 4.0, carbs_g: 70.0, fat_g: 17.0, fiber_g: 1.0 } },
  { names: ["twix"], per100g: { calories: 495, protein_g: 5.0, carbs_g: 63.0, fat_g: 25.0, fiber_g: 1.0 } },
  { names: ["bounty"], per100g: { calories: 471, protein_g: 4.0, carbs_g: 55.0, fat_g: 26.0, fiber_g: 4.0 } },
  { names: ["kit kat"], per100g: { calories: 518, protein_g: 7.0, carbs_g: 61.0, fat_g: 27.0, fiber_g: 2.0 } },
  { names: ["kinder bueno"], per100g: { calories: 572, protein_g: 9.0, carbs_g: 49.0, fat_g: 38.0, fiber_g: 2.0 } },
  { names: ["kinder cioccolato"], per100g: { calories: 565, protein_g: 9.0, carbs_g: 54.0, fat_g: 35.0, fiber_g: 1.0 } },
  { names: ["kinder fetta al latte"], per100g: { calories: 408, protein_g: 9.0, carbs_g: 47.0, fat_g: 21.0, fiber_g: 1.0 } },
  { names: ["kinder delice"], per100g: { calories: 435, protein_g: 6.0, carbs_g: 51.0, fat_g: 24.0, fiber_g: 1.5 } },
  { names: ["kinder paradiso"], per100g: { calories: 445, protein_g: 7.0, carbs_g: 47.0, fat_g: 26.0, fiber_g: 0.5 } },
  { names: ["kinder cereali"], per100g: { calories: 555, protein_g: 8.0, carbs_g: 55.0, fat_g: 34.0, fiber_g: 2.0 } },
  { names: ["oreo", "biscotti oreo"], per100g: { calories: 480, protein_g: 5.0, carbs_g: 68.0, fat_g: 21.0, fiber_g: 2.0 } },
  { names: ["ferrero rocher"], per100g: { calories: 575, protein_g: 8.0, carbs_g: 42.0, fat_g: 42.0, fiber_g: 3.0 } },
  { names: ["nutella biscuits"], per100g: { calories: 535, protein_g: 7.0, carbs_g: 57.0, fat_g: 31.0, fiber_g: 3.0 } },
  { names: ["nutella b-ready"], per100g: { calories: 530, protein_g: 7.0, carbs_g: 55.0, fat_g: 31.0, fiber_g: 3.0 } },
  { names: ["sfogliatella"], per100g: { calories: 345, protein_g: 6.0, carbs_g: 42.0, fat_g: 18.0, fiber_g: 1.0 } },
  { names: ["cassata", "cassata siciliana"], per100g: { calories: 330, protein_g: 6.0, carbs_g: 48.0, fat_g: 13.0, fiber_g: 1.0 } },
  { names: ["profiteroles"], per100g: { calories: 310, protein_g: 5.0, carbs_g: 32.0, fat_g: 18.0, fiber_g: 1.0 } },
  { names: ["pastiera", "pastiera napoletana"], per100g: { calories: 335, protein_g: 7.0, carbs_g: 45.0, fat_g: 14.0, fiber_g: 1.0 } },
  { names: ["creme caramel"], per100g: { calories: 118, protein_g: 3.0, carbs_g: 20.0, fat_g: 3.0, fiber_g: 0 } },
  { names: ["mousse al cioccolato"], per100g: { calories: 210, protein_g: 4.0, carbs_g: 22.0, fat_g: 12.0, fiber_g: 1.0 } },
  { names: ["torta margherita"], per100g: { calories: 340, protein_g: 7.0, carbs_g: 50.0, fat_g: 13.0, fiber_g: 0.5 } },
  { names: ["torta della nonna"], per100g: { calories: 315, protein_g: 6.0, carbs_g: 35.0, fat_g: 17.0, fiber_g: 1.0 } },
  { names: ["amaretti"], per100g: { calories: 432, protein_g: 9.0, carbs_g: 67.0, fat_g: 15.0, fiber_g: 3.0 } },
  { names: ["cantucci", "biscotti di prato"], per100g: { calories: 420, protein_g: 10.0, carbs_g: 65.0, fat_g: 14.0, fiber_g: 2.0 } },
  { names: ["brioche siciliana"], per100g: { calories: 360, protein_g: 8.0, carbs_g: 48.0, fat_g: 15.0, fiber_g: 1.5 } },
  { names: ["donut", "ciambella glassata"], per100g: { calories: 420, protein_g: 5.0, carbs_g: 50.0, fat_g: 22.0, fiber_g: 1.0 } },
  { names: ["brownie"], per100g: { calories: 405, protein_g: 5.0, carbs_g: 50.0, fat_g: 21.0, fiber_g: 2.0 } },
  { names: ["crepe", "crepes"], per100g: { calories: 190, protein_g: 6.0, carbs_g: 26.0, fat_g: 6.0, fiber_g: 0.5 } },

  // === BEVANDE AGGIUNTIVE ===
  { names: ["coca cola zero", "cola zero"], per100g: { calories: 0, protein_g: 0, carbs_g: 0, fat_g: 0, fiber_g: 0 } },
  { names: ["sprite"], per100g: { calories: 40, protein_g: 0, carbs_g: 10.0, fat_g: 0, fiber_g: 0 } },
  { names: ["chinotto"], per100g: { calories: 40, protein_g: 0, carbs_g: 10.0, fat_g: 0, fiber_g: 0 } },
  { names: ["caffe d'orzo", "caffè d'orzo", "orzo bevanda"], per100g: { calories: 20, protein_g: 0.5, carbs_g: 4.0, fat_g: 0.2, fiber_g: 0.3 } },
  { names: ["matcha latte"], per100g: { calories: 60, protein_g: 2.0, carbs_g: 8.0, fat_g: 2.0, fiber_g: 0 } },
  { names: ["cioccolata calda"], per100g: { calories: 80, protein_g: 3.0, carbs_g: 12.0, fat_g: 2.5, fiber_g: 0.5 } },
  { names: ["succo di pompelmo"], per100g: { calories: 39, protein_g: 0.5, carbs_g: 9.0, fat_g: 0.1, fiber_g: 0.1 } },
  { names: ["acqua di cocco"], per100g: { calories: 19, protein_g: 0.7, carbs_g: 4.0, fat_g: 0.2, fiber_g: 0 } },
  { names: ["succo ace"], per100g: { calories: 42, protein_g: 0.3, carbs_g: 10.0, fat_g: 0.1, fiber_g: 0.1 } },

  // === LATTICINI AGGIUNTIVI ===
  { names: ["burrata"], per100g: { calories: 321, protein_g: 15.0, carbs_g: 1.0, fat_g: 28.0, fiber_g: 0 } },
  { names: ["mozzarella light"], per100g: { calories: 200, protein_g: 20.0, carbs_g: 2.0, fat_g: 12.0, fiber_g: 0 } },
  { names: ["ricotta light"], per100g: { calories: 110, protein_g: 10.0, carbs_g: 4.0, fat_g: 6.0, fiber_g: 0 } },
  { names: ["philadelphia light"], per100g: { calories: 145, protein_g: 8.0, carbs_g: 5.0, fat_g: 10.0, fiber_g: 0 } },
  { names: ["robiola"], per100g: { calories: 310, protein_g: 12.0, carbs_g: 3.0, fat_g: 28.0, fiber_g: 0 } },
  { names: ["quark"], per100g: { calories: 68, protein_g: 12.0, carbs_g: 4.0, fat_g: 0.3, fiber_g: 0 } },
  { names: ["primo sale"], per100g: { calories: 271, protein_g: 18.0, carbs_g: 1.0, fat_g: 22.0, fiber_g: 0 } },
  { names: ["feta"], per100g: { calories: 264, protein_g: 14.0, carbs_g: 4.0, fat_g: 21.0, fiber_g: 0 } },
  { names: ["gouda"], per100g: { calories: 356, protein_g: 25.0, carbs_g: 2.0, fat_g: 27.0, fiber_g: 0 } },
  { names: ["cheddar"], per100g: { calories: 403, protein_g: 25.0, carbs_g: 1.0, fat_g: 33.0, fiber_g: 0 } },
  { names: ["grana padano"], per100g: { calories: 384, protein_g: 33.0, carbs_g: 0, fat_g: 28.0, fiber_g: 0 } },
  { names: ["yogurt proteico"], per100g: { calories: 60, protein_g: 10.0, carbs_g: 4.0, fat_g: 0.2, fiber_g: 0 } },
  { names: ["panna da cucina"], per100g: { calories: 200, protein_g: 3.0, carbs_g: 4.0, fat_g: 20.0, fiber_g: 0 } },
  { names: ["maionese light"], per100g: { calories: 330, protein_g: 1.0, carbs_g: 6.0, fat_g: 33.0, fiber_g: 0 } },

  // === PIATTI PRONTI AGGIUNTIVI ===
  { names: ["pasta alla norma"], per100g: { calories: 140, protein_g: 4.5, carbs_g: 20.0, fat_g: 5.0, fiber_g: 1.5 } },
  { names: ["pasta aglio olio e peperoncino", "aglio e olio"], per100g: { calories: 200, protein_g: 5.0, carbs_g: 25.0, fat_g: 9.0, fiber_g: 1.0 } },
  { names: ["orecchiette con cime di rapa"], per100g: { calories: 135, protein_g: 5.0, carbs_g: 20.0, fat_g: 4.0, fiber_g: 2.0 } },
  { names: ["penne all'arrabbiata", "arrabbiata"], per100g: { calories: 140, protein_g: 4.5, carbs_g: 22.0, fat_g: 4.0, fiber_g: 1.5 } },
  { names: ["pasta al ragu", "pasta al sugo di carne"], per100g: { calories: 155, protein_g: 7.0, carbs_g: 19.0, fat_g: 5.5, fiber_g: 1.0 } },
  { names: ["pasta alla gricia"], per100g: { calories: 195, protein_g: 8.0, carbs_g: 20.0, fat_g: 9.5, fiber_g: 0.7 } },
  { names: ["risotto ai frutti di mare"], per100g: { calories: 125, protein_g: 5.5, carbs_g: 19.0, fat_g: 3.0, fiber_g: 0.3 } },
  { names: ["risotto allo zafferano"], per100g: { calories: 140, protein_g: 3.0, carbs_g: 21.5, fat_g: 4.5, fiber_g: 0.2 } },
  { names: ["focaccia farcita"], per100g: { calories: 280, protein_g: 10.0, carbs_g: 30.0, fat_g: 13.0, fiber_g: 1.5 } },
  { names: ["piadina farcita con prosciutto e mozzarella"], per100g: { calories: 270, protein_g: 13.0, carbs_g: 30.0, fat_g: 11.0, fiber_g: 1.5 } },
  { names: ["insalata di farro"], per100g: { calories: 140, protein_g: 4.5, carbs_g: 22.0, fat_g: 4.0, fiber_g: 2.5 } },
  { names: ["insalata di quinoa"], per100g: { calories: 145, protein_g: 5.0, carbs_g: 21.0, fat_g: 4.5, fiber_g: 2.5 } },
  { names: ["sushi", "sushi misto"], per100g: { calories: 140, protein_g: 6.0, carbs_g: 22.0, fat_g: 3.0, fiber_g: 0.5 } },
  { names: ["poke bowl"], per100g: { calories: 130, protein_g: 8.0, carbs_g: 17.0, fat_g: 3.5, fiber_g: 1.5 } },
];
