...
const translations = {
  ...
  "workoutsPage.emptyState": { it: "Registra il tuo primo allenamento!", en: "Log your first workout!" },
  "workoutsPage.emptyStateDesc": { it: "Premi il pulsante + per iniziare", en: "Press the + button to start" },
  // ── Add workout modal ──
  ...
  "addWorkout.calories": { it: "Calorie bruciate", en: "Calories burned" },
  ...
  "addWorkout.back": { it: "Indietro", en: "Back" },
  "addWorkout.description": { it: "Descrizione", en: "Description" },
